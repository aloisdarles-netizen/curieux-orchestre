...
const CURIEUX_NOUVEAUTES = [
  {
    ...
    points: [
      ...
      "On ne peut pas donner une place qu'on n'a pas : une catégorie complète ou sans contingent n'est plus choisissable, et le menu annonce ce qu'il reste dans chacune. La carte passe en ambre quand c'est plein, en rouge si ça déborde, et un bandeau le dit quand tout est épuisé.",
