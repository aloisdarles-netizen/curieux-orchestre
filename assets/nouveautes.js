...
const CURIEUX_NOUVEAUTES = [
  {
    ...
    points: [
      ...
      "La page PROPOSE, elle n'affecte pas seule. La fiche liste chaque proposition avec son degré de sûreté : SÛRE quand une seule partie répond à l'instrument, ou quand le numéro de la fiche est celui de la partie (« Violon 2 » → « Violin2 ») ; PROBABLE quand c'est une convention (« Violon solo » → premier violon) ; À TRANCHER quand la fiche ne suffit pas (« Cor » devant « Cor 1-2 » et « Cor 3-4 » : on choisit dans une liste, les parties encore sans lecteur en tête). On décoche, on choisit, on valide — seul ce qui est coché ou choisi s'écrit.",
